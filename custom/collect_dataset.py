import sys
sys.path.append('/home/agv/rego/RL-VLM-F')
...
collection_config = {
    "demos": 750,
    "output_path": "/share1/RL-VLM-F/test_dummy",
    "resolution": (300, 300),
...
included_tasks = ['soccer-v2-goal-observable'] #for passing to the call_diff_agent use the env name without the goal observable
